<!DOCTYPE html>
<!-- SAVE THE ALMIGHTY OTTERS -->
<html>
	<head>
		<meta http-equiv="content-type" content="text/html; charset=utf-8" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
		<meta name="robot" content="index, nofollow">
		<title>Shoud I Buy an Apple Watch ?</title>
	</head>
	<body style="text-align:center;font-size:20px;font-family:sans-serif">
	<?php if(isset($_GET['answer']) && $_GET['answer'] == 'yes') { ?>
		<h1 style="font-size:5em;">NO MEANS NO</h1>
		<span>Stop trying to change the fact that it's stupid.</span>
	<?php } else { ?>
